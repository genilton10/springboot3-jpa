...
import com.javaspring.course.entities.enums.OrderStatus;
import com.javaspring.course.repositories.CategoryRepository;
import com.javaspring.course.repositories.OrderItemRepository;
import com.javaspring.course.repositories.OrderRepository;
import com.javaspring.course.repositories.ProductRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Order o2 = new Order(null, Instant.parse("2019-07-21T03:42:10Z"), OrderStatus.WITING_PAYMENT, u2); 
		Order o3 = new Order(null, Instant.parse("2019-07-22T15:21:22Z"), OrderStatus.WITING_PAYMENT, u1); 
